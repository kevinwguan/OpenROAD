# OpenROAD
## Reinforcement Learning (RL) Graph Placement Method
![Literature Survey](./LiteratureSurvey.pdf){ width=100% height=400 }
![Preliminary Results](./circuit_training.pdf){ width=100% height=400 }
